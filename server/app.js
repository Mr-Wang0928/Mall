...
app.use((req,res,next)=>{
    if(process.env.NODE_ENV === 'production'){
        ...
        res.append("Access-Control-Allow-Origin","http://localhost:5001");
...
app.listen(5000,()=>{
	// console.log('server is running at http://192.168.1.103:3000')
	console.log('server is running at http://192.168.43.44:5000')
});
